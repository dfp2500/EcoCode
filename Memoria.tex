...
\begin{itemize}
  ...
  \item \textbf{Greenhouse Gas Protocol (GHG Protocol) Adaptado al Software} \\
  ...
  \item \textbf{Life Cycle Assessment (LCA)} \\
  ...
  \begin{itemize}
    ...
    \item Complejidad operativa elevada
  \end{itemize}
  ...
  \begin{itemize}
    ...
    \item Fáciles de integrar en entornos DevOps
...
\begin{itemize}
    ...
    \item \textbf{Colaboración y compartición}: Facilita el trabajo en equipo y la compartición de resultados entre stakeholders.
\end{itemize}
