...
\begin{itemize}
  \item \textbf{Plugins de observación}: recogen datos del sistema. Por ejemplo, el plugin webpage-impact
  mide cuántos bytes son transferidos al cargar una página web.
...
ema. Por ejemplo, el plugin \texttt{webpage-impact} mide cuántos \textbf{bytes transferidos} al cargar una página web.\subsection*{Puntos fuertes:}
